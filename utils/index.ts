...
const createPrompt = (inputLanguage: string, outputLanguage: string, inputCode: string): string => {
...
export const OpenAIStream = async (
  ...
  const prompt: string = createPrompt(inputLanguage, outputLanguage, inputCode);
